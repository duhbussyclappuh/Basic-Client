...
namespace Basic_Client
{
    public class UICleaner
    {
        ...
        public static void start()
        {
            if (ModLoaded == false)
            {
                ...
                if (ui != null)
                {
                    foreach (var GO in ui.GetComponentsInChildren<UnityEngine.UI.Button>(true))
                    {
                        if (GO.name.Contains("Dashboard"))
                        {
    ...
    public class QMButtonBase
    {
        ...
        public void SetLocation(float buttonXLoc, float buttonYLoc)
        {
            ...
            button.GetComponent<Button>().name = $"{Elements.Identifier}-{btnType}{btnTag}";
        }
    ...
    public class QMSlider
    {
        ...
        private void Initialize(Transform location, float posX, float posY, string sliderLabel, float minValue, float maxValue, float defaultValue, Action<float> sliderAction, Color? labelColor = null)
        {
            ...
            slider.name = $"{Elements.Identifier}-QMSlider-{APIUtils.RandomNumbers()}";
            ...
            Elements.allQMSliders.Add(this);
        }
    ...
    public class QMSingleButton : QMButtonBase
    {
        ...
        private protected void InitButton(float btnXLocation, float btnYLocation, string btnText, Action btnAction, string btnToolTip, Color? btnTextColor = null, Sprite icon = null, bool wingMenu = false)
        {
            ...
            SetActive(true);
            Elements.allQMSingleButtons.Add(this);
    ...
    public class QMToggleButton : QMButtonBase
    {
        ...
        private void Initialize(float btnXLocation, float btnYLocation, string btnText, Action onAction, Action offAction, string btnToolTip, bool defaultState)
        {
            ...
            Elements.allQMToggleButtons.Add(this);
        }
    ...
    public class QMNestedButton
    {
        ...
        {
            MenuName = $"{Elements.Identifier}-Menu-{APIUtils.RandomNumbers()}";
            ...
            BackButton.GetComponentInChildren<Button>().onClick.AddListener(new Action(() =>
            {
                if (isRoot)
                {
                    ...
                    {
                        APIUtils.GetMenuStateControllerInstance().Method_Public_Void_String_Boolean_Boolean_0
                        ("QuickMenu" + btnQMLoc.Remove(0, 5));
                        return;
                    }
            ...
            Elements.allQMNestedButtons.Add(this);
        }
